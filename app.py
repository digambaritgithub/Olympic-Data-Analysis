...
# Top Statistics Analysis
    ...
    fig = px.line(nations_over_time, x='Edition', y='Unique_region')
    st.title("Participating Nations over the years")
    st.plotly_chart(fig)

    events_over_time = help.data_over_time(df, 'Event')  # Replace 'Event' with the actual column name for events
    fig = px.line(events_over_time, x='Edition', y='Unique_Event')  # Replace 'Event' with the actual column name for events
    st.title("Events Over Time")
    st.plotly_chart(fig)

    athletes_over_time = help.data_over_time(df, 'Name')  # Replace 'Athlete' with the actual column name for athletes
    fig = px.line(athletes_over_time, x='Edition', y='Unique_Name')  # Replace 'Athlete' with the actual column name for athletes
...
# Weight v Height scatter plot.
    ...
    fig, ax = plt.subplots()
    sns.scatterplot(data=temp_df, x='Weight', y='Height', hue='Medal', style='Sex', s=50, ax=ax)
    st.pyplot(fig)

# Men Vs Women Participate distribution plot.
